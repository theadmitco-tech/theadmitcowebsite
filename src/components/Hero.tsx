    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center pt-20 px-6 overflow-hidden">
      ...
      >
        ...
        <p className="text-lg md:text-xl text-text-dark/70 mb-12 max-w-2xl mx-auto font-light leading-relaxed">
          From GMAT prep to interview strategy — we support your full journey.
        </p>

        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
          <Link to="/consultation" className="btn-primary flex items-center gap-2 group">
        ...
        <p className="mt-8 text-sm text-text-dark/50 max-w-lg mx-auto font-light">
          Built by applicants who've been through the process. <br />
          Selective cohorts. High-touch guidance.
        </p>
      </motion.div>
    </section>
